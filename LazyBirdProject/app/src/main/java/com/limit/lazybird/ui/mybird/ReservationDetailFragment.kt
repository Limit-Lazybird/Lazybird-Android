...
class ReservationDetailFragment :
    BaseFragment<FragmentReservationDetailBinding>(FragmentReservationDetailBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.reservationExhibitionShortList.observe(viewLifecycleOwner) { exhibitList ->
            ...
            binding.reservationDetailRecyclerView.adapter =
                ReservationDetailAdapter(exhibitList).apply {
    ...
    private fun showDeleteDialog(exhbtCd: String) {
        ...
        val action =
            ReservationDetailFragmentDirections.actionReservationDetailFragmentToDeleteExhbtDialogFragment(
                dialogInfo,
                exhbtCd
            )
    ...
    private fun moveToExhibitionDetail(exhibitionInfo: Exhbt) {
        navController.navigate(
            ReservationDetailFragmentDirections.actionReservationDetailFragmentToExhibitionDetailFragment(
                exhibitionInfo
            )
        )
    }
    ...
    private fun moveToEarlyBirdDetail(exhibitionInfo: Exhbt) {
        navController.navigate(
            ReservationDetailFragmentDirections.actionReservationDetailFragmentToEarlyBirdDetailFragment(
                exhibitionInfo
            )
        )
    }
